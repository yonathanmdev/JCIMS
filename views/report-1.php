...
if (isset($_GET['export']) && $_GET['export'] == 'excel') {
    ...
    header("Content-Disposition: attachment; filename=Job_Seekers_Report_W1.xls");
...
<!-- የኤክስፖርት ሊንኩ የተመረጠውን ብራንች እና ቀናት ይዞ እንዲሄድ ተደርጓል -->
<div class="no-print" style="margin-bottom: 20px; text-align: right;">
    <a href="?export=excel&branch_id=<?= urlencode($myBranchId ?? ($_POST['branch_id'] ?? '')); ?>&start_date=<?= urlencode($startdate); ?>&end_date=<?= urlencode($enddate); ?>" 
       class="btn btn-success" 
       style="background-color: #28a745; color: white; padding: 8px 16px; text-decoration: none; border-radius: 4px; font-weight: bold; font-family: sans-serif;">
       Export to Excel (.xlsx)
    </a>
</div>
<?php endif; ?>
<!-- The export button will only show up on the web screen, not in the exported excel file -->
...
<div class="table-responsive">
    <table class="table table-bordered table-striped text-center" border="1">
        <thead class="table-primary">
            <tr>
                <th rowspan="2" style="width: 10%;">ስትራቴጂያዊ ግቦች</th>
                <th rowspan="2">አመልካቾች</th>
                <th rowspan="2" style="width: 4%;">መለኪያ</th>
                <th colspan="3">ከተማ</th>
                <th colspan="3">ገጠር</th>
        ...
        <tbody>
            ...
            <tr>
                <td class="text-left">በዕድሜ (15-29 ዓመት)</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">በዕድሜ (30-64 ዓመት)</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">የተመዘገቡ የዩኒቨርሲቲ ተመራቂዎች</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">የተመዘገቡ የቴክኒክና ሙያ ተመራቂዎች</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">የተመዘገቡ አካል ጉዳተኞች</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">የተመዘገቡ ከስደት ተመላሾች</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">የተመዘገቡ የሀገር ውስጥ ተፈናቃዮች</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">የተመዘገቡ መኖሪያቸው ጎዳና የሆኑ</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">ግንዛቤ ማስጨባጫ የወሰዱ ስራ ፈላጊዎች</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">ግንዛቤ ማስጨባጫ የወሰዱ ወጣቶች</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">የግንዛቤ ማስጨበጫ ስራ ፈላጊ ወላጆች</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">የግንዛቤ ማስጨበጫ ሌሎች ህብረተሰብ ክፍሎች</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">የግንዛቤ ማስጨበጫ የወሰዱ የዩኒቨርሲቲ ተመራቂዎች</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">የግንዛቤ ማስጨበጫ የወሰዱ የቴክኒክና ሙያ ኮሌጅ ተመራቂዎች</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">የግንዛቤ ማስጨበጫ የወሰዱ አካል ጉዳተኞች</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">የግንዛቤ ማስጨበጫ የወሰዱ ከስደት ተመላሾች</td>
                <td>በቁጥር</td>
            ...
            <tr>
                <td class="text-left">ለስራ ፈላጊዎች ተገቢውን የምክርና የመረጃ አገልግሎት መስጠት</td>
                <td>በቁጥር</td>
                <td><?= $report['urban_m_advice']; ?></td>
                <td><?= $report['urban_f_advice']; ?></td>
                <td><?= $totalUrbanadvice; ?></td>
